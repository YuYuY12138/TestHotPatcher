...
// UE 5.7 new pure virtual functions
...
void FHotPatcherPackageWriter::GetOplogAttachments(TArrayView<FName> PackageNames, TArrayView<FUtf8StringView> AttachmentKeys, TUniqueFunction<void(FName PackageName, FUtf8StringView AttachmentKey, FCbObject&& Attachment)>&& Callback)
{
	// Oplog attachments are not implemented by FHotPatcherPackageWriter
...
{
	// GetCommitStatus is not implemented by FHotPatcherPackageWriter
