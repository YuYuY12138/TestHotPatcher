...
FString UFlibReflectionHelper::ExportPropertyToText(UObject* Object, FName PropertyName)
{
	...
	if(Property)
	{
		Property->ExportTextItem_Direct(Value, Property->ContainerPtrToValuePtr<uint8>(Object), nullptr, Object, PPF_None);
	}
	return Value;
}
...
bool UFlibReflectionHelper::ImportPropertyValueFromText(UObject* Object, FName PropertyName,const FString& Text)
{
	...
	if(Property)
	{
		Property->ImportText_Direct(*Text, Property->ContainerPtrToValuePtr<uint8>(Object), Object, PPF_None);
	}
	return true;
}
